---
summary: 'Tmux-based manual testing recipe for exercising mcpx against real MCP servers.'
read_when:
...
- OAuth flows are triggered automatically when needed; no manual auth command required.
