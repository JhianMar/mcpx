...
export function serializeConnectionIssue(
  issue?: ConnectionIssue,
): SerializedConnectionIssue | undefined {
  if (!issue) {
    return undefined;
  }
  return {
...
export function formatErrorMessage(error: unknown): string {
  ...
  try {
    ...
    // Expected: error may contain circular references; fall back to generic message
    return "Unknown error";
  }
}
