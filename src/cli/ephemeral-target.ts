...
} from "@/cli/adhoc-server.js";
import { looksLikeHttpUrl, normalizeHttpUrlCandidate } from "@/cli/http-utils.js";
...
export async function prepareEphemeralServerTarget(
  ...
  options.runtime.registerDefinition(resolution.definition, {
    overwrite: true,
  });
  if (spec.persistPath) {
